...
|----------------|```dart InputDecoration(icon: Icon(Icons.account_circle, color: Colors.blue))```|```dart InputDecoration(prefixIcon: Icon(Icons.account_circle, color: Colors.blue))```|```dart InputDecoration(suffixIcon: Icon(Icons.account_circle, color: Colors.blue))```|
